...
return [
    ...
    'caches' => [
        ...
        /**
         * What cache driver do you want to use - more information:
         * https://laravel.com/docs/5.6/cache#driver-prerequisites.
         */
        'driver' => 'file',
    ...
    /**
     * This function will be called every time after export, it should be globally accessible function
     * (eg. Laravel helper function)
